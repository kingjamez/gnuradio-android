...
class SoundSine(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "SoundSine", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("SoundSine")
        ...
        self.settings = Qt.QSettings("GNU Radio", "SoundSine")
...
def main(top_block_cls=SoundSine, options=None):
