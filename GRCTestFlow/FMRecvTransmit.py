...
class FMRecvTransmit(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "FMRecvTransmit", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FMRecvTransmit")
        ...
        self.settings = Qt.QSettings("GNU Radio", "FMRecvTransmit")
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.iio_pluto_source_0 = iio.fmcomms2_source_fc32(uri if uri else iio.get_pluto_uri(), [True, True], (16*1024))
        ...
        self.iio_pluto_sink_0 = iio.fmcomms2_sink_fc32(uri if uri else iio.get_pluto_uri(), [True, True], 16384, False)
...
def main(top_block_cls=FMRecvTransmit, options=None):
